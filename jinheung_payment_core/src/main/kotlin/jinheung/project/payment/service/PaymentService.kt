...
//                    canceledLog = CanceledLog.of(statusCode = 400, ) //
//                }
//            }
...
//                }
//            }
//            val payment = this.payCancel(impUid, isImpUidExists, )
//            canceledLog = CanceledLog.of(statusCode = statusCode, message = e.localizedMessage, )
//        } finally {
...
//    }
//
//    fun payCancel(impUid: String, isImpUidExist : Boolean,  price: BigDecimal) :  {
//        try {
